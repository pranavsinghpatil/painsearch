...
- `src/collect.py` — bounded adapters for HN, Lobsters feeds, and GitHub Issues; Reddit adapter retained but paused; every record carries provenance and a lineage key
...
## Quickstart
```bash
# Requires no Reddit credentials: Reddit adapter is paused
